  ...
  describe "semantic similarity tests" do
    ...
    test "famous quotes and their paraphrases are recognized as alike" do
      alike_pairs = [
        ...
        {"It was the best of times, it was the worst of times.", "It was an age of extremes, both wonderful and terrible."},
        {"All that glitters is not gold.", "Appearances can be deceiving."},
        {"To be or not to be, that is the question.", "Existence versus non-existence is the fundamental dilemma."},
        
        # Common expressions with similar meanings
        {"The early bird catches the worm.", "Those who start early gain advantages."},
        {"Don't count your chickens before they hatch.", "Avoid assuming future success prematurely."},
    ...
    test "semantically different sentences are recognized as not alike" do
      ...
      unlike_pairs = [
        ...
        {"Quantum physics explores subatomic particles.", "Renaissance art featured perspective and realism."},
